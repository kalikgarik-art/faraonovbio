        ...
        >
          <div className="flex flex-col items-center gap-3 text-center px-4">
            <motion.div
              ...
              className="relative"
            >
              <h1 className="text-2xl sm:text-3xl font-bold tracking-widest text-white/95 font-mono-code drop-shadow-[0_0_15px_rgba(255,255,255,0.4)] lowercase">
                {title}
              </h1>
            </motion.div>
            ...
            <motion.div
              ...
              className="flex items-center gap-2 text-xs sm:text-sm tracking-wider text-zinc-300 font-mono-code lowercase"
            >
          ...
          <div className="absolute bottom-8 text-[11px] text-zinc-500 font-mono-code">
            нажмите в любое место для перехода и запуска музыки
          </div>
        </motion.div>
      )}
    </AnimatePresence>
