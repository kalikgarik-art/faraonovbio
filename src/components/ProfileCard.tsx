...
export const ProfileCard: React.FC<ProfileCardProps> = ({
  ...
  const currentViews = viewsCount ?? profile.viewsCount;
    ...
    >
      ...
      >
        ...
        <div className="relative w-full h-36 sm:h-40 overflow-hidden bg-zinc-900">
          ...
          {/* Top Info Badge (dev.faraonov) */}
          <div className="absolute top-3 right-3 flex items-center gap-1.5 z-10 select-none">
            <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-black/40 backdrop-blur-md border border-white/10 text-[11px] font-mono-code text-zinc-300 shadow-sm">
